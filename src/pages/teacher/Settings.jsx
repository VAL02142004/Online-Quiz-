...
import { UserCircle, Save, BookOpen } from 'lucide-react';
  ...
  useEffect(() => {
    if (initialData && watchedFields) {
      const currentFormData = {
        ...
        gradeLevel: watchedFields.gradeLevel || '',
        employeeId: watchedFields.employeeId || ''
      };
    ...
    <DashboardLayout title="Teacher Settings">
      <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-soft p-6 animate-fade-in">
        <div className="flex items-center mb-6">
          ...
          <h2 className="text-xl font-semibold text-gray-800">Teacher Profile Settings</h2>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="space-y-4">
            ...
            <Input
              ...
              placeholder="e.g., Grade 10-12, Elementary, High School"
            />
            ...
            {hasChanges && (
              <Button
                ...
                onClick={() => {
                  ...
                  setValue('gradeLevel', initialData.gradeLevel);
